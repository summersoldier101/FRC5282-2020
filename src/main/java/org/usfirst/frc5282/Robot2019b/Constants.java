 ...
 * Global constants are in all capitial letters with space separaters
 *
 */
public class Constants {
	...
	// General Constants ___________________________________________________________________

	public static final double DRIVE_POWER_REDUCTION = 1;    // %Reduction: This is for a button that slows the robot down so it is controllable
	...
	//eg. switching a talon for a victor.
